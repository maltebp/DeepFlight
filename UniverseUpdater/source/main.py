...
def updateUniverse():
    ...
    if currentRound is None:
        ...
        print("Finished creating new current round")

    if len(futureRounds) is 0:
        print("\nCreating future round")
        # No future round, so we create on
        createRound(currentRound.endDate)
        print("Finished creating future round")
...
def createRound(startTime):
    ...
    for planet in planets:
        ...
        tracks.append(generate.generateTrack(planet, existingPlanetTracks))
