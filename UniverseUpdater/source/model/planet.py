...
default_planets = [
    Planet("Smar",      [230, 90, 65],      2,  8, 16, 11, 15), # 11
    Planet("Aerth",     [0, 102, 0],        2, 10, 10, 10, 10), # 10
    Planet("Turnsa",    [127, 63, 192],     2, 15,  8, 13,  8), # 13
    Planet("Lupto",     [100, 147, 219],    2, 12, 12, 12,  1) # 13
]